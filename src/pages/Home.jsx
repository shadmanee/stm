...
export default function Home() {
  ...
  const news_items = [
    {
      ...
      date: "2026-01-21",
      content:
        "I've finished two semesters of my Master's program at BRAC University.",
      type: "education",
    },
    {
      ...
      date: "2025-09-30",
      content:
        "I concluded my role as a Junior Data Scientist at IDARE to pursue my Master's full-time.",
      type: "work",
    },
    {
      displayDate: "20 September 2025",
      date: "2025-09-20",
      content: "I'm done with the first semester of my Master's program.",
      type: "education",
    },
    {
      ...
      date: "2025-06-17",
      content:
        "I started my MS in Computer Science & Engineering at BRAC University.",
      type: "education",
    },
    {
      displayDate: "1 May 2025",
      date: "2025-05-01",
      content: "I got promoted to Junior Data Scientist at IDARE.",
      type: "work",
    },
    {
      displayDate: "22 December 2024",
      date: "2024-12-22",
      content:
        "One of my papers won the Best Technical Presentation Award at ICCIT 2024.",
      type: "research",
    },
    {
      displayDate: "2 May 2024",
      date: "2024-05-02",
      content: "I just got my first job as an AI Research Apprentice at IDARE.",
      type: "work",
    },
    {
      displayDate: "4 April 2024",
      date: "2024-04-04",
      content:
        "I completed my Bachelor's (BS) in CSE from MIST with a GPA of 3.91 on a scale of 4.0.",
      type: "education",
    },
    {
      date: "2024-08-02",
      displayDate: "2 August 2024",
      content: "I published my first paper as a co-author at ISDA 2023.",
    },
    {
      date: "2025-06-10",
      displayDate: "10 June 2025",
      content:
        "Two of my research papers were published in the IEEE Xplore proceedings at ICCIT 2024.",
    },
    {
      date: "2024-03-04",
      displayDate: "4 March 2024",
      content:
        "I have successfully defended my undergraduate thesis at MIST under the supervision of Dr. Muhammad Nazrul Islam.",
    },
  ];
  ...
  // TODO: obviously AI generated - figure it out and update this section as necessary
  const interests = [
    {
      ...
      icon: (
        <svg
          ...
          className={`h-8 w-8 ${darkMode ? "text-teal-400" : "text-teal-600"}`}
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
  ...
  const publications = [
    {
      ...
      doi: "https://doi.org/10.1109/ICCIT64611.2024.11022487",
      pdf: "https://drive.google.com/file/d/1LSAfbBKucutowf9hHk5Jg7NrnNhkxrQn/view?usp=drive_link",
    },
    {
      title:
        "Unlocking Voices: Assessing Usability and Accessibility of Mobile Apps for Stutter Reduction",
      conference: "ICCIT 2024",
      doi: "https://doi.org/10.1109/ICCIT64611.2024.11022350",
      pdf: "https://drive.google.com/file/d/1DWBrc-YX5RqhMvGG_JZU1m_TVGNOhv8o/view?usp=drive_link",
    },
    {
      title:
        "PPDHero: Requirements Elicitation and Development of a System to Empower New Mothers on Postpartum Depression",
      conference: "ISDA 2023",
      doi: "https://doi.org/10.1007/978-3-031-64850-2_37",
      pdf: "https://drive.google.com/file/d/144WZxaBb5GJO96JlPoS-lS4xkHeHO70h/view?usp=drive_link",
    },
  ];
    ...
    >
              ...
              >
                ...
                >
                  <li className="flex items-start">
                    ...
                    <span>
                      NLP, AI/ML, Data Science, Human-Centered Computing
                    </span>
                  </li>
                  <li className="flex items-start">
                    <svg
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Add this section from the other repository (iykyk) - if needed or if i start working on anything currently lol */}
            ...
            >
              {publications.map((pub, index) => (
                <li key={index}>
                  ...
                  >
                    {pub.title} ({pub.conference})
                  </a>{" "}
                  <a
                    href={pub.pdf}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-xs ml-1 opacity-70 hover:opacity-100 transition-opacity"
                  >
                    [pdf]
                  </a>
                </li>
            ...
            <div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  ...
                  <a
                    href="https://github.com/shadmanee" // Replace with your link
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`${
                      darkMode
                        ? "bg-gray-700 hover:bg-gray-500"
                        : "bg-gray-200 hover:bg-gray-300"
                    } p-3 rounded-full transition-colors duration-300 inline-flex items-center justify-center`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0">
              <p className={`'${darkMode ? "text-gray-400" : "text-gray-500"}`}>
                © {new Date().getFullYear()} All rights reserved by Shadmanee
                Tasneem Mulk.
              </p>
            </div>
          </div>
